...
Title = tk.Label(root, text = "Game compedium", font = (pixel_font_title), fg = "black", bg = "red").grid(row=0, column=0, columnspan=2, pady=20, padx = 190)#Stand in for the title, I willl change later
...
#I am using a tutorial by Alina Chudnova
    ...
    ttttitle = tk.Label(TTT, text = "Tic Tac Toe", font = pixel_font_title, fg = "#0D3B66", bg = "#FAF0CA")#The title of the game
    ttttitle.grid(row = 0, column = 0, columnspan = 3, pady = 0)#Placing the title in the grid
    ...
    for i in range(3):#Three rows for buttons
        ...
        for r in range(3):#Three columns per row for the buttons
            button = tk.Button(TTT, text = "", font = pixel_font_buttons, borderwidth=0, bg="#0D3B66", fg="#FAF0CA",
                                width = 15, height = 3, padx= 4,
            ...
            button.grid(row = i + 1, column = r, padx = 5, pady = 5)#Place the buttons in a grid, the padding is the lines
    ...
    def check_winner():#Checking if there is a winner
        ...
        for win in winning:
            if win[0] == win[1] == win[2] != "":#If all three values in a row are the same and not empty
                ttttitle.config(text = f"Player {win[0]} wins!")#Changing the title to show who won
                for i in range(3):
                    for r in range(3):
                        buttons[i][r].config(state = "disabled")#Disabling all buttons after someone wins
...
hangman_button = tk.Button(root, image = hangman_image, command = hangman, font = pixel_font_buttons ,
                           fg = "#FAF0CA", bg = "#0D3B66", borderwidth = 0 ,padx = 67, pady = 10)
...
Memory_button = tk.Button(root, text = "Memory Mania", command = Memory, font = pixel_font_buttons, fg = "#FAF0CA", bg = "#0D3B66", borderwidth = 0, padx = 30, pady = 10).grid(row = 4, column = 0, rowspan = 2, pady = 50, padx = 85)


blackjack_button = tk.Button(root, text = "BlackJack", command = blackjack, font = pixel_font_buttons, fg = "#FAF0CA", bg = "#0D3B66", borderwidth = 0, padx = 75, pady = 10).grid(row = 4, column = 1, pady = 50, padx = 10)
