...
help_button.grid(row=0, column=2, sticky="ne", padx=0, pady=10)
...
def hangman():
    ...
    """
    global scores
    global frame_hangman
    global frame_ttt
    global blackjack_frame
    global Title
    global help_button
...
def blackjack():
    ...
    Dframe.pack(padx=20, pady=5, side="right")
    ...
    Pframe.pack(padx=20, pady=5, side="left")
    ...
    hit_frame = tk.Frame(blackjack, bg="#2D2D4E")
    hit_frame.pack(padx=20, pady=5, anchor="e")
    ...
    hit_button.pack(pady=10, padx=10, side="bottom")

    hit_button_image = resize_cards(f"Python/back_card.png")
    hit
